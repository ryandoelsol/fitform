    ...
    <section id="contact" className="py-32 bg-white dark:bg-stone-950 relative z-30 transition-colors duration-700">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          {/* Map / Image Visual */}
          <div className="relative h-[500px] lg:h-auto rounded-3xl overflow-hidden bg-stone-200 dark:bg-stone-900">
            {/* Using a dark map style image placeholder or actual map iframe style */}
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3763.556730164627!2d-99.2458!3d19.3885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDIzJzE4LjYiTiA5OcKwMTQnNDQuOSJX!5e0!3m2!1sen!2smx!4v1620000000000!5m2!1sen!2smx" 
              width="100%" 
              height="100%" 
            ...
            <div className="absolute inset-0 pointer-events-none border border-stone-900/10 dark:border-white/10 rounded-3xl"></div>
          </div>
