    ...
    <section id="team" className="py-32 bg-stone-50 dark:bg-stone-950 relative z-30 transition-colors duration-700">
        <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row items-end justify-between mb-16">
                ...
                <a href="#" className="text-[10px] uppercase tracking-[0.2em] text-stone-900 dark:text-white border-b border-stone-300 dark:border-white/30 pb-1 mt-6 md:mt-0 hover:border-stone-900 dark:hover:border-white transition-colors">
                    Ver todo el equipo
                </a>
            </div>
