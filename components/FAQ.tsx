...
const FAQS: FAQItem[] = [
  {
    ...
    answer: "Un entrenamiento de 50 minutos de alta intensidad y bajo impacto. Utilizamos movimientos lentos y controlados para trabajar core, fuerza y resistencia, fusionando lo mejor del Pilates con entrenamiento funcional."
  },
  {
    question: "¿Necesito experiencia previa?",
    answer: "No. Nuestros coaches están capacitados para guiarte desde tu primera clase, ofreciendo modificaciones para principiantes y desafíos para avanzados."
  },
  {
    question: "¿Qué debo llevar?",
    answer: "Ropa cómoda deportiva y calcetines antiderrapantes (obligatorios por seguridad e higiene). Si no tienes, vendemos en el estudio. Trae tu botella de agua."
  },
  {
    question: "Política de Cancelación",
    answer: "Debes cancelar tu reserva con al menos 10 horas de anticipación. Si cancelas después o no asistes (No Show), se pierde la clase y aplica una penalización de $150 MXN."
  },
  {
    question: "Lista de Espera",
    answer: "Si la clase está llena, únete a la lista de espera. Si se libera un lugar (hasta 10h antes), se te asignará automáticamente. Debes estar pendiente de tu correo."
  },
];
